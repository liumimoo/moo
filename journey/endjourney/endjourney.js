// pages/journey/endjourney/endjourney.js
...
tendtoappraise:function(){
  var startplaceadd = this.data.startplacead;
  var endplaceadd = this.data.endplacead;
  wx.redirectTo({
    url: '../../appraise/appraise?startplacead=' + startplaceadd + '&endplacead=' + endplaceadd
  });
},
  /**
   * 生命周期函数--监听页面加载
